...
def main(config, resume, infile, outfile, sigma):
    ...
    print(x.max(), x.min())
    write_wav(outfile, x.cpu().numpy(), sr, True)
...
if __name__ == '__main__':
    ...
    main(config, args.resume, args.infile, args.outfile, args.sigma)
